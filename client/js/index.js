...
var _ = require('lodash'),
    ...
    createBoard = require('almost-joint-ifml-layout').createBoard,
    ifml = require('./ifml').ifml,
    pcn = require('./pcn').pcn,
    ifml2pcn = require('./ifml2pcn').ifml2pcn,
    defaultLink = require('./defaultlink').defaultLink,
    createElementsMenu = require('almost-joint-ifml-layout').createElementsMenu,
    createStatisticsMenu = require('./statistics').StatisticsMenu,
    createModalEdit = require('almost-joint-ifml-layout').createModalEdit,
