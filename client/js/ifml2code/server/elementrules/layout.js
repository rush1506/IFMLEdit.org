...
exports.rules = [
    createRule( // map list
        function (element, model) { return model.isLayout(element) && element.attributes.stereotype === 'list'; },
    ...
    createRule( // map form
        function (element, model) { return model.isLayout(element) && element.attributes.stereotype === 'form'; },
        function (element, model) {
            var id = element.id,
                name = element.attributes.name,
                top = model.getTopLevelAncestor(element),
    ...
    createRule( // map details
        function (element, model) { return model.isLayout(element) && element.attributes.stereotype === 'details'; },
        function (element, model) {
            var id = element.id,
                name = element.attributes.name,
                collection = element.attributes.collection,
